...
public class CategoriaService
{
    ...
    public CategoriaService(IConfiguration config)
    {
        ...
        _listId = Environment.GetEnvironmentVariable("ListCategoriaId");
    }

    // 1. Obter todos os itens da lista
    public async Task<List<IDictionary<string, object>>> GetCategoriaListItemsAsync()
    {
        try
        {
    ...
    public async Task<IDictionary<string, object>?> GetCategoriaListItemByIdAsync(string itemId)
    {
        try
        {
    ...
    public async Task<bool> CreateCategoriaAsync(Dictionary<string, object> fields)
    {
        try
        {
    ...
    public async Task<bool> DeleteCategoriaAsync(string itemId)
    {
        try
        {
            await _graphClient
