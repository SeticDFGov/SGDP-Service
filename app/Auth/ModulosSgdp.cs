...
///    acesso_modulo) e os papéis de módulo já existentes (Users.PapelPgia dá acesso
///    ao PGIA; Users.PapelContratacoes dá acesso à Supervisão Contínua).
...
public static class ModulosSgdp
{
    ...
    public static readonly string[] Todos = { Demandas, Pgia, Contratacoes, Administracao };
    ...
    /// (Users.PapelContratacoes), gravado pela mesma tela. Administração só vem do Keycloak.
    /// </summary>
    public static readonly string[] Concedidos = { Demandas, Pgia };
    ...
    /// do Keycloak.
    /// </summary>
    public static readonly string[] Liberaveis = { Demandas, Pgia, Contratacoes };
...
{
    // Na fila, esperando a administração (ou a SGDI, no PGIA)
