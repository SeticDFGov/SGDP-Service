...
namespace demanda_service.Migrations
{
    ...
    [Migration("20260203004459_RefatoracaoAtividadesEtapas")]
    partial class RefatoracaoAtividadesEtapas
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.Atividade", b =>
                {
                    ...
                    b.Property<string>("RESPONSAVEL_ATIVIDADE")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
            ...
            modelBuilder.Entity("Models.Atividade", b =>
                {
                    b.HasOne("Etapa", "Etapa")
                        .WithMany("Atividades")
                        .HasForeignKey("EtapaProjetoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
