...
namespace demanda_service.Migrations
{
    ...
    [Migration("20260924215548_PeFluxos")]
    partial class PeFluxos
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Models.Planejamento.PeDocBloco", b =>
                {
                    ...
                    b.ToTable("pe_doc_bloco", null, t =>
                        {
                            t.HasCheckConstraint("ck_pe_doc_bloco_tipo", "tipo IN ('texto','tabela_secao','lista_tema','matriz_swot','fluxo','quebra_pagina')");
                        });
                });
            ...
            modelBuilder.Entity("Models.Planejamento.PeDocModelo", b =>
                {
                    ...
                    b.ToTable("pe_doc_modelo", null, t =>
                        {
                            t.HasCheckConstraint("ck_pe_doc_modelo_tipo", "tipo IN ('pdtic')");
                        });
                });
            ...
            modelBuilder.Entity("Models.Planejamento.PeDocVersao", b =>
                {
                    ...
                    b.HasIndex("PdticId", "Numero")
                        .IsUnique()
                        .HasDatabaseName("ux_pe_doc_versao_numero");
                    ...
                    b.ToTable("pe_modelo_historico", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_pe_modelo_historico_entidade", "entidade IN ('nivel','etapa','passo','secao','campo','opcao','orgao_nivel','orgao_ajuste','doc_capitulo','doc_bloco','fluxo_modelo')");
                        });
                });
